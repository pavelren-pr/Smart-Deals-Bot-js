...
const costVVP_Tug = 4190; //Безопасность судоходства на ВВП РГР План безопасной буксировки
const costOLVVP_Stvor = 790; //Общая лоция ВВП Расчёт линейного нав створа
const costNIL_VertAngl_RGR = 1290; //НиЛ РГР Вертикальный угол
...
const costAstro_kr1 = 1390; // Астрономия Помощь на контрольной по ТВА
...
const WORK_PAYMENT = {
    ...
    nil_2tide: myCardNumber,
    nil_3tide: myCardNumber,
    nil_4tide: myCardNumber,
    nil_5tide: myCardNumber,
    nil_ALLtide: myCardNumber,
    MiUS_tasks: myCardNumber,
    MiUS_tasks_break: myCardNumber,
    MiUS_tasks_tasksbreak: myCardNumber,
    tss_test_pract2: ivanCardNumber,
    VVPRadio_kurs: myCardNumber,
...
const inlineKeyboardMiUS4 = new InlineKeyboard()
    ...
    .text('ВСЕ ЗАДАЧИ‼️выгода 600₽‼️', 'MiUS_tasks_tasksbreak').row()
    .text('Назад 🔙', 'back4year')
...
В подарок предоставляется гайд как правильно чертить графики в курсовой, а так же вся необходимая теория к курсовой.\n
